...
class Manage extends Command {
	...
	protected function execute(InputInterface $input, OutputInterface $output) {
		...
		$backend = $this->config->getSystemValue('logtype', self::DEFAULT_BACKEND);
	 ...
	 * @return bool
	 */
	protected function isValidBackend($backend) {
		return class_exists('OC_Log_'.$backend);
	}
